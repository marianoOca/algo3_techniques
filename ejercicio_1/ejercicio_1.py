...
def correr_instancia(archivo_instancia, orden):
    # Leer archivo de la instancia.
    instancia = leer_instancia(archivo_instancia)
    
    # Crear proceso para ejecutar el codigo.
    process = subprocess.Popen(["./ejercicio_1", orden], stderr=subprocess.PIPE, stdout=subprocess.PIPE, stdin=subprocess.PIPE, universal_newlines = True)
...
file.write(F"{sys.argv[1]}, {sys.argv[2]}\n")
file.close()
correr_instancia(sys.argv[1], sys.argv[2])
